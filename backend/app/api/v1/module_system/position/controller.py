...
@PositionRouter.get("/page", summary="分页查询岗位", description="分页查询岗位")
async def get_obj_page_controller(
    ...
    result_dict = await PositionService.get_position_page_service(search=search, auth=auth, page=page)
    log.info(f"查询岗位列表成功")
